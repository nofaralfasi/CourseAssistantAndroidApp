...
public class Student
{
    ...
    public StudyGroup FindSGByName(String SGName)
    {
        for (StudyGroup studyGroup : studyGroups)
        {
            if (studyGroup.getStudyGroupName().equals(SGName))
            {
                return studyGroup;
            }
        }
    ...
    public StudyGroup GetStudyGroupByIndex(int index)
    {
        return studyGroups.get(index);
    }


    public void UpdatedStudyGroup(int index, Context context, StudyGroup oldStudyGroup)
    {
        StudyGroup studyGroup = this.studyGroups.get(index);
        Collections.sort(this.studyGroups);


        CalendarHelper calendarHelper = new CalendarHelper(oldStudyGroup.GetStudyGroupDateAsCalendar().get(Calendar.HOUR_OF_DAY), oldStudyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MINUTE), oldStudyGroup.GetStudyGroupDateAsCalendar().get(Calendar.DAY_OF_MONTH), oldStudyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MONTH), oldStudyGroup.GetStudyGroupDateAsCalendar().get(Calendar.YEAR), context.getResources().getString(R.string.term) + " " + oldStudyGroup.getTerm().toString(), oldStudyGroup.getCourse(), TaskType.StudyGroup);
        this.calendarManager.RemoveFromCalendar(calendarHelper, context);

        calendarHelper = new CalendarHelper(studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.HOUR_OF_DAY), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MINUTE), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.DAY_OF_MONTH), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MONTH), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.YEAR), context.getResources().getString(R.string.term) + " " , studyGroup.getCourse(), TaskType.StudyGroup);
        this.calendarManager.AddToCalendar(calendarHelper, context);
        studyGroup.setPushId(this.UpdateNotification(studyGroup.getPushId(), studyGroup.getCourse().getCourseName() + " " , context.getResources().getString(R.string.exam), studyGroup.GetStudyGroupDateAsCalendar(), context, studyGroup.getNotify()));
    }
    ...
    public void AddStudyGroup(StudyGroup studyGroup, Context context)
    {
        this.studyGroups.add(studyGroup);
        Collections.sort(this.studyGroups);
        CalendarHelper calendarHelper = new CalendarHelper(studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.HOUR_OF_DAY), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MINUTE), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.DAY_OF_MONTH), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.MONTH), studyGroup.GetStudyGroupDateAsCalendar().get(Calendar.YEAR), context.getResources().getString(R.string.term) + " " + studyGroup.getTerm().toString(), studyGroup.getCourse(), TaskType.StudyGroup);
        this.calendarManager.AddToCalendar(calendarHelper, context);
        studyGroup.setPushId(this.AddNotification(studyGroup.getCourse().getCourseName() + " ", context.getResources().getString(R.string.studyGroup), context, studyGroup.GetStudyGroupDateAsCalendar(), studyGroup.getNotify()));
    }
