...
//import com.example.nofar.finalProject.GUI.Adapters.CompletedAdapter;
 ...
 */
public class CompleteTwoSidesItemHelper<T extends ViewHolder> extends ItemTouchHelper.SimpleCallback
{
    private SwipeHelperListener listener;

    public CompleteTwoSidesItemHelper(int dragDirs, int swipeDirs, SwipeHelperListener listener)
    {
