...
public class MySensor extends Service implements SensorEventListener {
    ...
    ArrayList<DevicePositionChangedListener> mPositionListeners = new ArrayList<>();
    DevicePositionChangedListener tempListener;
    ...
    public class LocalBinder extends Binder {
        ...
        public void registerListener(@NonNull DevicePositionChangedListener listener){
